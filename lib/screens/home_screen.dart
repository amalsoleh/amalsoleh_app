              ...
              children: [
                Row(
                  children: [
                    ...
                    Text('Menu', style: TextStyle(
                      fontSize: 18, fontWeight: FontWeight.w600, color: _gold
                    )),
                    const Spacer(),
                    IconButton(
                ...
                Expanded(
                  child: GridView.count(
                    ...
                    children: [
                      _MenuTile(icon: Icons.home, label: 'Home', onTap: () {
                        Navigator.of(context).pop();
                      }),
                      _MenuTile(icon: Icons.library_books, label: 'Library', onTap: () {
                        Navigator.of(context).pop();
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (_) => const BookListScreen(),
                        ));
                      }),
                      _MenuTile(icon: Icons.card_giftcard, label: 'Earn Rewards', onTap: () {/*TODO*/}),
                      _MenuTile(icon: Icons.monetization_on, label: 'My Points', onTap: () {/*TODO*/}),
                      _MenuTile(icon: Icons.settings, label: 'Settings', onTap: () {/*TODO*/}),
                    ],
                  ),
                ),
              ],
